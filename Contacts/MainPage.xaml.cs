...
namespace Contacts
{
    public partial class MainPage : ContentPage
    {
        ...
        /*
        private void SaveButton_Clicked1(object sender, EventArgs e)
        {

        }

        private void SaveButton_Clicked2(object sender, EventArgs e)
        {

        }

        private void SaveButton_Clicked3(object sender, EventArgs e)
        {
